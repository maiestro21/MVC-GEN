...
<html lang="en">
    <head>
        ...
        <title>User_group_corelation</title>
...
<!-- nav bar ends -->
  ...
  <div class="jumbotron-overlay ">
      ...
      <h1 class="display-4">User_group_corelation view</h1>
         <p>
            <a href="https://github.com/maiestro21/MVC-GEN" class="btn btn-lg btn-success btn-circle my-4 mr-3">Learn more</a>
         </p>
      </div>
    </div>
</div>
         ...
         <div class="container mt-5" id="about">
                   <h1 class="text-center py-4">Advantages of MVC-GEN</h1>
                  ...
                  <div class="row text-center mt-5">
                   <div class="col-md-3">
                    <div class="card shadow">
                      ...
                      <div class="card-body">
                        <h4 class="card-title">Ready to user</h4>
                        <p class="card-text">With minimal configurations you can get rid of the backend provisioning. </p>
                       </div>
                      </div>
                    </div>
                    </div>
                     ...
                     <div class="card shadow">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">Made as light and customizable as possible. </p>
                       </div>
                      </div>
                    </div>
                    </div>
                     ...
                     <div class="card shadow">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">It generates the REST, you do the rest. </p>
                        </div>
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="col-md-3">
                     <div class="card shadow">
                      ...
                      <div class="card-body">
                        <h4 class="card-title">Easy to work on</h4>
                        <p class="card-text">It's just code, frameworks and MVC. </p>
                        </div>
                      </div>
              ...
              <div class="container mt-5  text-center">
                 <p class="pt-5 pb-2 h4 text-monospace">Speed up your development with MVC Backend ready to roll.</p>
                <div class="row">
             ...
             <div class="container mt-5">
                <div class="row py-5">
                  <div class="col-md-4">
                   ...
                   <p class="lead text-muted">Maybe this will help you save some frontend time ☺.</p>
           ...
           <!-- features start -->
             <div class="container mt-5 ">
                   <p class="py-4 h3 text-center">More elements</p>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="card shadow">
                        <div class="card-body">
                          <div class="media">
                            ...
                            <div class="media-body">
                              <h4 class="mt-0 tex-dark">Lorem ipsum</h4>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-3">
                            <h3>User_group_corelation view</h3>
                            ...
                            <div class="row no-gutters">
                                <div class="col-6 col-lg-3">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="#" class="text-muted">Ready to use</a>
                                        </li>
                                        <li>
                                ...
                                <div class="col-6 col-lg-3">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="#" class="text-muted">CodeIgniter3</a>
                                        </li>
                                        <li>
                                            <a href="#" class="text-muted">Flask</a>
                                        </li>
                                        <li>
                                            <a href="#" class="text-muted">NodeJS</a>
                                        </li>
                                        <li>
                                            <a href="#" class="text-muted">REST</a>
                                        </li>
                                    </ul>
                                </div>
                                <!--end of col-->
